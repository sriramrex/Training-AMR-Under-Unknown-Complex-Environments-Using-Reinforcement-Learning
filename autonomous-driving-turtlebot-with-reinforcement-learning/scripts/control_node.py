...
# Real robot
REAL_ROBOT = True  #False if there is no real robot
...
if __name__ == '__main__':
    try:
        ...
        robot_in_pos = False
        print("waiting for goal pose on rviz")
        ...
        orientation_list = [goal_pose.pose.orientation.x, goal_pose.pose.orientation.y, goal_pose.pose.orientation.z, goal_pose.pose.orientation.w]
        (roll, pitch, yaw) = euler_from_quaternion (orientation_list)
        THETA_GOAL=180*yaw/math.pi
        print("Recevived the following information")
        print(X_GOAL)
        print(Y_GOAL)
        print(THETA_GOAL)
